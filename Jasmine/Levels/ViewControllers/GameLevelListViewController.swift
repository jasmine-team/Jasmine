...
//  Jasmine
//
//  Created by Xien Dong on 10/4/17.
...
class GameLevelListViewController: UIViewController {
    ...
    // MARK: Constants
    private static let viewCellIdentifier = "GameLevelViewCell"
    ...
    @IBAction func onLevelsCategoriesSwitched(_ sender: UISegmentedControl) {
    }
